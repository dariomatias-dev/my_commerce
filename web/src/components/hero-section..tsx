    ...
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-white px-6">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        ...
        <h1 className="mb-6 text-5xl leading-[1.1] font-black tracking-[-0.04em] text-slate-950 sm:text-7xl lg:text-8xl">
          CONSTRUA. <br />
          <span className="relative inline-block bg-gradient-to-r from-indigo-600 via-indigo-500 to-indigo-600 bg-clip-text text-transparent italic">
            VENDA AGORA.
            <svg
        ...
        <div className="flex flex-col items-center justify-center gap-8 lg:flex-row lg:gap-12">
          <div className="group relative">
            <div className="absolute -inset-1 rounded-full bg-gradient-to-r from-indigo-600 to-violet-600 opacity-20 blur transition duration-500 group-hover:opacity-40"></div>
