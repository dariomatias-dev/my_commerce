  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="absolute top-[-10%] left-[-10%] h-[500px] w-[500px] rounded-full bg-indigo-50/50 blur-[120px]" />
        <div className="absolute right-[-10%] bottom-[-10%] h-[400px] w-[400px] rounded-full bg-slate-50/50 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        <div className="grid items-center gap-8 lg:grid-cols-3">
          ...
          {/* Plan: PRO (Featured) */}
          <div className="relative flex flex-col rounded-[3.5rem] bg-slate-950 p-12 text-white shadow-[0_40px_80px_-20px_rgba(79,70,229,0.3)] ring-4 ring-indigo-600/10 lg:-mt-8 lg:mb-[-2rem]">
