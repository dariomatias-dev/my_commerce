        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="relative mb-40 flex flex-col items-center gap-16 lg:flex-row">
            ...
            <div className="relative lg:w-1/2">
              ...
              <div className="relative">
                <div className="absolute top-1/4 -left-12 z-20 hidden animate-bounce rounded-3xl border border-white bg-white/80 p-6 shadow-2xl backdrop-blur-xl duration-4000 lg:block">
          ...
          <div className="flex flex-col-reverse items-center gap-16 lg:flex-row">
            <div className="relative lg:w-1/2">
              ...
              <div className="relative overflow-hidden rounded-[3rem] border-12 border-slate-50 shadow-2xl">
                <Image
