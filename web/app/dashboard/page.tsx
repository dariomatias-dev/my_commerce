      ...
      <main className="mx-auto max-w-400 px-6 pt-32 pb-12">
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            ...
            <button className="group flex min-h-80 flex-col items-center justify-center rounded-[2.5rem] border-2 border-dashed border-slate-200 p-8 text-center transition-all hover:border-indigo-600 hover:bg-white">
