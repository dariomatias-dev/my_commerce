    ...
    <OrdersDashboard
      ...
      actions={
        <Link
          ...
          className="group flex h-18 items-center gap-4 rounded-2xl border border-slate-100 px-8 text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600 transition-all hover:bg-indigo-600 hover:text-white active:scale-95 shadow-sm"
        >
