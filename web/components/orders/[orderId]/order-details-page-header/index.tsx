import { ArrowLeft, Calendar, Clock, Hash, Package, Receipt, ShieldCheck } from "lucide-react";
...
export const OrderDetailsPageHeader = ({ order, onBack }: OrderDetailsPageHeaderProps) => {
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="mb-10 flex flex-wrap items-center justify-between gap-6">
        <button
          onClick={onBack}
          className="flex items-center gap-2 text-[10px] font-black tracking-widest text-slate-400 uppercase transition-colors hover:text-indigo-600"
        >
      ...
      <section className="mb-12 overflow-hidden rounded-[3rem] border border-slate-100 bg-white shadow-2xl shadow-slate-200/50">
        <div className="flex flex-col lg:flex-row">
          <div className="flex flex-1 flex-col justify-center border-b border-slate-50 p-10 lg:border-r lg:border-b-0">
            ...
            <h1 className="text-5xl font-black tracking-tighter text-slate-950 uppercase italic lg:text-6xl">
          ...
          <div className="bg-slate-950 p-10 text-white lg:w-96">
            <div className="flex h-full flex-col justify-between">
              ...
              <div className="mt-10 flex items-center gap-3 rounded-2xl bg-white/5 p-4">
                ...
                <p className="text-[10px] leading-tight font-bold text-white/70 uppercase">
