...
export const InventoryAlert = ({
  ...
  return (
    <aside className="lg:col-span-4">
      <div className="rounded-[2.5rem] bg-slate-950 p-8 text-white shadow-2xl border border-slate-900 sticky top-40">
        ...
        <div className="min-h-45">
          {loading ? (
            ...
            <div className="flex h-36 items-center justify-center text-center">
              <p className="text-[10px] font-black text-red-500 uppercase italic tracking-widest leading-relaxed px-4">
                {error}
              </p>
            </div>
          ) : lowStockProducts.length > 0 ? (
