...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse<CategoryResponseDTO>> create(@RequestBody CategoryRequestDTO request) {
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Categoria criada com sucesso", CategoryResponseDTO.from(category))
        );
    }
    ...
    public ResponseEntity<ApiResponse<CategoryResponseDTO>> getById(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Categoria obtida com sucesso", CategoryResponseDTO.from(category))
        );
    }
    ...
    public ResponseEntity<ApiResponse<CategoryResponseDTO>> update(
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Categoria atualizada com sucesso", CategoryResponseDTO.from(category))
        );
    }
    ...
    public ResponseEntity<ApiResponse<Void>> delete(@PathVariable UUID id) {
        ...
        return ResponseEntity.ok(
                ApiResponse.success("Categoria excluída com sucesso", null)
        );
    }
}
