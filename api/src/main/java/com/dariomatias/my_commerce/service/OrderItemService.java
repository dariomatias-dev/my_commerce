...
public class OrderItemService {
    ...
    private final OrderItemContract itemRepository;
    private final OrderContract orderRepository;
    private final ProductContract productRepository;

    public OrderItemService(OrderItemContract itemRepository,
    ...
    public Page<OrderItem> getAllByOrder(UUID orderId, Pageable pageable) {
        return itemRepository.findAllByOrderId(orderId, pageable);
    }

    public Page<OrderItem> getAllByProduct(UUID productId, Pageable pageable) {
        return itemRepository.findAllByProductId(productId, pageable);
    }
